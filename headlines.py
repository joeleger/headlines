...
app = Flask(__name__)
OPEN_WEATHER_API_KEY = os.environ.get("OPEN_WEATHER")
OPEN_CURRENCY_API_KEY = os.environ.get("OPEN_CURRENCY")
WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather?q={}&units=metric&APPID=" + OPEN_WEATHER_API_KEY
CURRENCY_URL = "https://openexchangerates.org//api/latest.json?app_id=" + OPEN_CURRENCY_API_KEY
...
def home():
    ...
    pub_title = str.title(publication)
